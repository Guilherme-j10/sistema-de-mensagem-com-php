	...
	<head>
		...
		<style type="text/css">
			*{margin: 0px; padding: 0px; font-family: Arial; box-sizing: border-box; outline: none; list-style: none; text-decoration: none;}
			...
			.line ul li{width: 300px; flex: 1; height: 350px; background-color: #ccc; margin: 10px 10px; text-align: center; padding: 1.5%; border-radius: 5px; display: flex; justify-content: center; align-items: center; flex-direction: column;}
